...
%token VOID BOOL INT DOUBLE STRING NEW
%token CLASS THIS _NULL
%token NEGATIVE ADD MINUS MULTIPLY DIVIDE MOD SELFINC SELFDEC
%token GREATEREQUAL EQUAL UNEQUAL LESS LESSEQUAL ASSIGN
